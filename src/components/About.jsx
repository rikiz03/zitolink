  ...
  return (
    <div className="my-20" id="about">
      ...
      <div className="flex flex-col items-center">
        <a
          href="#"
          className="flex flex-col items-center md:flex-row md:max-w-screen-md gap-10"
        >
          <img
          ...
          <div className="flex flex-col justify-between p-4 leading-normal">
            <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
              ...
              Stack Software Engineer. As a self-taught Full-stack Software
              Developer, I take pride in my ability to solve complex problems
              and maintain the highest quality standards in all my work. I have
              a wealth of experience working with a wide range of programming
              languages, frameworks, and tools, which enables me to build
              intuitive <box className="font-bold"> user interfaces </box> and
              develop robust <box className="font-bold"> server-side </box>{" "}
