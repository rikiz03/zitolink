  ...
  return (
    <div className="my-20" id="about">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:pt-4 pl-4 md:pl-16 md:justify-between gap-10">
        <div className="flex items-start md:items-end md:w-1/3">
          <img
        ...
        <div className="leading-normal md:w-2/3">
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 md:w-2/3">
            ...
            Developer, I take pride in my ability to solve complex problems and
            maintain the highest quality standards in all my work. I have a
            wealth of experience working with a wide range of programming
